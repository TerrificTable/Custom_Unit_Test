...
public class ExpectFalse extends Assertions {

    public <T> ExpectFalse(boolean value) {
        total++;
        ...
        if (value) {
            ...
            assertions_failed.add("Failure in `" + caller_class + "/" + caller_method + "/" + this.getClass().getSimpleName() + "`: Expected False Got: " + value);
            fails++;
        } else {
