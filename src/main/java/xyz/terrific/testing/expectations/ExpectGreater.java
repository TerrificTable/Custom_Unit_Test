...
public class ExpectGreater extends Assertions {

    public <T> ExpectGreater(T expected, T actual) {
        total++;
        ...
        if (!((int) expected > (int) actual)) {
            ...
            assertions_failed.add("Failure in `" + caller_class + "/" + caller_method + "/" + this.getClass().getSimpleName() + "`: Expected greater than: " + expected + " \tGot: " + actual);
            fails++;
        } else {
